...
@endif
 ...
 @endif
 {!! Form::open(['id' => 'dataForm', 'method' => 'PATCH', 'url' => '/massagetypes/' . $massagetype->id ]) !!}
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    {!!Form::text('massagetypename',$massagetype->massagetypename, ['placeholder' => '', 'class' => 'form-control col-lg-12', 'required' => '' ])!!}
                    </div>
                    <div class="form-group">
                    {!!Form::label('massagetypedescription', 'Massage Type Description', array('class' => 'form-control-label'))!!}
                    {!!Form::text('massagetypedescription',$massagetype->massagetypedescription, ['placeholder' => '', 'class' => 'form-control col-lg-12', 'required' => '' ])!!}
                    </div>
                    <div class="form-group">
                    {!!Form::label('price', 'Price', array('class' => 'form-control-label'))!!}
                    {!!Form::text('price',$massagetype->price, ['placeholder' => '', 'class' => 'form-control col-lg-12', 'required' => '' ])!!}
                    </div>
